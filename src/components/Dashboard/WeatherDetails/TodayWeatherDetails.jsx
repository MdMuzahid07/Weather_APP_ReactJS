    ...
    return (
        <div className='mt-1 shrink-0'>
            <h2 className='font-bold text-xs mb-3 flex items-center justify-between'>
                <span className={isDark ? 'text-slate-200' : 'text-slate-800'}>More details of today's weather</span>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
                ...
                <div className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className={`font-bold text-[11px] flex justify-between items-center ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                        <span>Humidity</span>
                    ...
                    <h3 className={`text-lg text-center font-extrabold my-1 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                        {current?.humidity ?? '--'}% <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded uppercase ml-1 ${
                            isDark
                                ? 'text-sky-400 bg-sky-500/15 border border-sky-500/30'
                                : 'text-sky-700 bg-sky-100 border border-sky-200'
                        }`}>{current?.humidityStatus}</span>
                    </h3>
                ...
                <div className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <h3 className={`text-lg text-center font-extrabold my-1 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                        {current?.windSpeed ?? '--'} <span className={`text-xs font-semibold ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{current?.windUnit}</span>
                    </h3>
                    <div className={`w-full rounded-full h-1.5 mt-2 overflow-hidden ${isDark ? 'bg-slate-800' : 'bg-slate-200'}`}>
                ...
                <div className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <h3 className={`text-lg text-center font-extrabold my-1 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                        {current?.precipitation ?? '0'} <span className={`text-xs font-semibold ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{current?.precipUnit}</span>
                    </h3>
                    <div className={`w-full rounded-full h-1.5 mt-2 overflow-hidden ${isDark ? 'bg-slate-800' : 'bg-slate-200'}`}>
                ...
                <div className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <h3 className={`text-lg text-center font-extrabold my-1 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                        {current?.uvIndex ?? '0'} <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded uppercase ml-1 ${
                            isDark
                                ? 'text-amber-400 bg-amber-500/15 border border-amber-500/30'
                                : 'text-amber-700 bg-amber-100 border border-amber-200'
                        }`}>{current?.uvStatus}</span>
                    </h3>
                    <div className={`w-full rounded-full h-1.5 mt-2 overflow-hidden ${isDark ? 'bg-slate-800' : 'bg-slate-200'}`}>
                ...
                <div className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <h3 className={`text-lg text-center font-extrabold my-1 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                        {current?.feelsLike ?? '--'}°<span className={`text-xs font-semibold ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{unit}</span>
                    </h3>
                    <div className={`w-full rounded-full h-1.5 mt-2 overflow-hidden ${isDark ? 'bg-slate-800' : 'bg-slate-200'}`}>
