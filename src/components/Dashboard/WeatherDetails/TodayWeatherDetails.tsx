...
const TodayWeatherDetails: React.FC = () => {
    ...
    return (
        <section aria-label="More details of today's weather" className='mt-1 shrink-0'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
                {/* 1. Humidity */}
                <article className={`p-3 rounded-2xl border transition-all group ${
                    theme === 'dark'
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        <h3>Humidity</h3>
                        <div className="w-7 h-7 rounded-lg bg-sky-500/15 text-sky-600 dark:text-sky-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
                            <Droplets size={16} className="animate-pulse" />
                        </div>
                    </div>
                    <p className='text-lg text-center font-extrabold my-1 text-slate-900 dark:text-slate-100'>
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-800/80 rounded-full h-1.5 mt-2 overflow-hidden" aria-hidden="true">
                ...
                <article className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        <h3>Wind Speed</h3>
                        <div className="w-7 h-7 rounded-lg bg-indigo-500/15 text-indigo-600 dark:text-indigo-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
                ...
                <article className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        <h3>Precipitation</h3>
                        <div className="w-7 h-7 rounded-lg bg-cyan-500/15 text-cyan-600 dark:text-cyan-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
                ...
                <article className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        <h3>UV Index</h3>
                        <div className="w-7 h-7 rounded-lg bg-amber-500/15 text-amber-600 dark:text-amber-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
                ...
                <article className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        <h3>Feels Like</h3>
                        <div className="w-7 h-7 rounded-lg bg-orange-500/15 text-orange-600 dark:text-orange-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
                ...
                <article className={`p-3 rounded-2xl border transition-all group ${
                    ...
                    <div className='font-bold text-[11px] flex justify-between items-center text-slate-700 dark:text-slate-300'>
                        ...
                        <div className="w-7 h-7 rounded-lg bg-teal-500/15 text-teal-600 dark:text-teal-400 flex items-center justify-center group-hover:scale-110 transition-transform" aria-hidden="true">
