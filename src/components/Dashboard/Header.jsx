...
import { Navigation, ShieldCheck, MapPin, Sun, Moon } from 'lucide-react';
        ...
        <header className={`flex flex-wrap justify-between items-center px-4 md:px-5 pt-4 pb-3 mb-0 gap-2 shrink-0 border-b transition-colors ${
            ...
            <div>
                <div className='flex items-center gap-2'>
                    ...
                    <span className={`font-bold text-xs px-2.5 py-0.5 rounded-full flex items-center gap-1 ${
                        theme === 'dark'
                ...
                <p className={`text-xs font-medium flex items-center gap-1.5 mt-1 ${theme === 'dark' ? 'text-slate-400' : 'text-gray-500'}`}>
            ...
            <div className='flex items-center gap-2'>
                ...
                >
                    <Navigation size={15} className="group-hover:rotate-45 transition-transform duration-300" />
                </button>
            </div>
        </header>
    );
